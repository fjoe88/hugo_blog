...
Biocpkg <- function (pkg) {
    sprintf("[%s](https://github.com/fjoe88/%s)", pkg, pkg)
}
...
![logo](zhoufang.jpg){width=100%}

```{r}
# When in export mode the little dots are unaligned, so fix that. 
if(PDF_EXPORT){
  cat("View this CV online with links at fjoe88.github.io/cv")
}
```
...
- <i class="fa fa-envelope"></i> fjoe88@gmail.com
- <i class="fa fa-twitter"></i> fjoe88
- <i class="fa fa-github"></i> github.com/fjoe88
- <i class="fa fa-link"></i> fjoe88.netlify.app
- <i class="fa fa-phone"></i> +1 (917) 355-6785
...
```{r, results='asis'}
intro_text <- glue("Data Analysis Engineer at [Micron Technology](http://www.micron.com). I have developed more than 5 R packages, including ",
  {Biocpkg("d8ahelper")}, ", ", 
  {Biocpkg("copier")}, ", ",
  {Biocpkg("rtrend")}, 
  ", to help semiconductor professionals to explore and understand their data.")

cat(sanitize_links(intro_text))
```

I work on improving our semiconductor wafer yield and fabrication efficiency through extracting insights from data.
